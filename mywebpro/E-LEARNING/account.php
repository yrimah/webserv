...
<body>
    ...
    <div class="header">
        <div class="container">
            <div class="row">
                <div class="col">
                    Welcome to your account - <?php 
                    if (isset($_SESSION["name"]))
                        echo $_SESSION["name"];
                    // else if (isset($_POST["logname"]))
                    if (isset($_POST["signbtn"]))
                        echo "<button href=\"out.php?out=true\" name=\"outbtn\" class=\"btn btn-outline-danger\" style=\"margin: 5px;\"disabled>Sign-out</button>";
                    else
                        echo "<button href=\"out.php?out=true\" name=\"outbtn\" class=\"btn btn-outline-danger\" style=\"margin: 5px;\">Sign-out</button>";
                        ?>
                </div>
                <div class="col">
                    <ul>
            ...
            <div class="modal-body">
                <form method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="logpasswd" class="form-control" id="exampleInputPassword1">
                    </div>
